...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.isListenerNameMatch = isListenerNameMatch;
	...
	function isListenerNameMatch(flow, name) {
	  return name === flow.name() || name === flow.guid() || name === '*';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol ? "symbol" : typeof obj; }; /* globals VERSION */
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = function (flow, defaults, name, data) {
	   ...
	   */
	  flow.namespace.match = function (localisedNS) {
	    (0, _utils.assert)(typeof localisedNS != 'string', _consts.ERRORS.invalidListener, localisedNS);
	
	    var path = flow.namespace.path().reverse();
	    var segments = localisedNS.split(_consts.NS_SEPARATOR).reverse();
	
	    // early return: if the event names differ there is
	    // no need to check the path
	    if (!(0, _utils.isListenerNameMatch)(path[0], segments[0])) return false;
	
	    return segments.every(function (segment) {
	      var foundSegment = false;
	      while (path.length) {
	        var p = path.shift();
	        if ((0, _utils.isListenerNameMatch)(p, segment)) {
	          foundSegment = true;
	          break;
	        }
	      }
